...
class _VerifyCodeState extends State<VerifyCode> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Center(child:Text('Code Confirmation')),
      leading: InkWell(
        onTap: (){
                ...
                child:Column(
                  children: [
                    Container(
                      ...
                      height: 200,
                      child: Lottie.network('https://assets4.lottiefiles.com/packages/lf20_eg88dyk9.json'),
                    ),
                    SizedBox(height: 16,),
                    ...
                    Text('The code will expired soon: ' + time.toString(),
                        style:TextStyle(
                            ...
                            color: time <= 30 ? Colors.red[600] : Colors.green[600]
                        )),
                    ElevatedButton(
                      child: Text("Send new code", style:
                      TextStyle(color: Colors.white,)),
                      style: ElevatedButton.styleFrom(
                        primary: time <=30 ? Colors.lightBlue : Colors.grey[300],
                        elevation: 0,
                    ...
                    SizedBox(height: 16,),
                    Text('Tap on this "Confirm" button to Login to your money transfer account'),
                    SizedBox(height: 16,),
                    ElevatedButton(
